<?php
$config['zjy_web'] = '金可观';
$config['zjy_title'] = '【开发环境】金可观—中国第一家"互联网+"黄金购买掌上平台';
$config['zjy_keyword'] = '金可观,金可观APP,黄金珠宝价格,黄金购买,黄金买卖,黄金租赁,黄金理财';
$config['zjy_description'] = '金可观是中国第一家黄金珠宝移动商城,提供黄金买卖、黄金租赁、黄金理财等金融服务,以市场最低价为您挑选最为优质的黄金珠宝首饰.';
// 版本
...
//客服邮箱
$config['zjy_email'] = 'service@kg-gold.com';

//备案
$config['zjy_icp'] = '闽ICP备14020275号';

//微信号
$config['zjy_weixin'] = 'jinkeguan';

//qq群
$config['zjy_qqqun'] = '472409055';
?>