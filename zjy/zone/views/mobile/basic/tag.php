		...
		<?php foreach ($list as $key => $v): ?>
			<div class="pb10 border-b mt10">
				<a href="<?php echo base_url('mobile/basic/articleDetail').'/'.$v['id']; ?>" class="zjy-flex-box">
					...
					<?php else:?>
						<img src="<?php echo base_url('zone/images/common/getqrcode.png');?>" width="80" height="60" class="mr10">
					<?php endif;?>
					<div class="zjy-flex-1 line-h25">
						<div class="font-14 articleTitle"><?php echo strlen($v['title']) > 76 ? substr($v['title'], 0, 76) . '...' : $v['title']; ?></div>
						<div class="font-98 font-12 tr"><span class="mr20"><?php echo strstr($v['updateTime'], ' ', true); ?></span><span><i class="icon-user mr5"></i><?php echo $v['followNumber']; ?></span></div>
					</div>
				</a>
			</div>
		<?php endforeach; ?>
