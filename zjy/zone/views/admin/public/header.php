...
<head>
 ...
 <script src="<?php echo base_url('zone/js/common/jquery-2.2.3.js');?>"></script>
 <!--[if lt IE 8]>
    <script src="//g.alicdn.com/aliyun/console/1.3.45/scripts/browser-not-supported.js"></script>
    <![endif]-->
</head>
